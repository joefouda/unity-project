...
import { NbToastrService, NbGlobalPhysicalPosition, NbLayoutDirectionService, NbLayoutDirection, NbThemeService } from '@nebular/theme';
    ...
    this.route.paramMap.subscribe((data: any) => {
      if (data.params.token != null) {
        this.api.get("get-user-from-token/" + data.params.token).subscribe((response: any) => {
          ...
          this.toastrService.warning(this.messages.EXPIRED_REQUEST, this.messages.ERROR, { position: NbGlobalPhysicalPosition.BOTTOM_LEFT });
